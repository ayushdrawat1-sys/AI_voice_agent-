    ...
    return (
      ...
      >
        {!started && (
          ...
          bg-[#0f0b1a] rounded-3xl overflow-hidden
          shadow-[0_0_70px_rgba(255,45,149,0.12),12px_12px_24px_#05040a,-12px_-12px_24px_#171021]
          border border-white/6
          w-full max-w-sm mx-4 md:mx-0">
            
            {/* Decorative Neon Icons */}
            <RetroTvIcon className="absolute top-4 right-4 w-10 h-10 text-[#18F3FF] -rotate-12 pointer-events-none drop-shadow-[0_0_12px_rgba(24,243,255,0.6)] opacity-95" />
            <RetroTvIcon className="absolute bottom-16 left-2 w-8 h-8 text-[#FF2D95] rotate-6 pointer-events-none drop-shadow-[0_0_12px_rgba(255,45,149,0.6)] opacity-95" />
            ...
            <p className="max-w-prose leading-6 font-medium text-white/80 z-10 relative">
              Enter your stage name and power up the neon machine.
            </p>
            ...
            <div className="mt-8 w-full z-10 relative">
              ...
              <div className="flex w-full items-stretch gap-2">
                <input
                  ...
                  bg-[#0f0b1a] text-white placeholder:text-white/40 font-semibold
                  shadow-[inset_4px_4px_8px_#05040a,inset_-4px_-4px_8px_#171021]
                  focus:outline-none focus:ring-2 focus:ring-[#FF2D95]/30
                ...
                <Button
                  ...
                  bg-gradient-to-r from-[#FF2D95] to-[#18F3FF] 
                  text-[#0f0b1a] border-none
                  hover:from-[#ff5aa8] hover:to-[#3af3ff]
        ...
        {started && (
          <div className="text-center text-white text-2xl font-bold animate-pulse md:pr-12 drop-shadow-lg">
            🔥 Powering up… Neon MC is tuning the synth
          </div>
        )}
      </div>
    );
